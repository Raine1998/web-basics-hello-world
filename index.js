...
$(function() {
  ...
  //dont put () on buttonClicked here--already invokes the function before you click the button so if we leave out the (), it waits
...
function buttonClicked(){
  //$("#results-area").text("button clicked");
